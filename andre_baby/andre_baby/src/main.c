...
//	PID1_1 Regler GESCHWINDIGKEIT
	...
	float error1_1 = 0.0, input1_1 = 0.0, dInput1_1 = 0.0, lastInput1_1 = 0.0;
	
	float	mySetpoint1_1 = 	2418;
...
//	PID2_1 Regler POSITION
	...
	float error2_1 = 0.0, input2_1 = 0.0, dInput2_1 = 0.0, lastInput2_1 = 0.0;
	
	float	mySetpoint2_1	=	0.0;
...
//	PID1_2 Regler GESCHWINDIGKEIT
	...
	float error1_2 = 0.0, input1_2 = 0.0, dInput1_2 = 0.0, lastInput1_2 = 0.0;

	float	mySetpoint1_2 = 	2304;
...
//	PID2_2 Regler POSITION
	...
	float error2_2 = 0.0, input2_2 = 0.0, dInput2_2 = 0.0, lastInput2_2 = 0.0;

	float	mySetpoint2_2	=	0.0;
...
//	Input Regler		Nullpunkt			Amplitude		 Wert für 33°						Winkel in Grad	
	mySetpoint1_1	=	2418		+		AM_1		*	(1641			*	sin(( (VZ_1) *	TW_1 +  90)			* WK1));
	mySetpoint1_2	=	2304		+		AM_1		*	(1641			*	sin(( (VZ_1) *	TW_1)				* WK1));

	TW_1 = TW_1 + SP_1;									// jede ms wird der Winkel um SP_1° größer -> 1000 x 0,36 = 360°/s		

	if (TAE_1ms % 50 == 0)								// 50ms
	{	
		SP_1 = SP_1 + VZ_2 * 0.005;						// * 0.01 -> doppelte Umdrehungsanzahl
		if (SP_1 == 0.5)
		{	
			VZ_2 = -VZ_2;
		}
	...
	if (TAE_1ms % 8000 == 0)							// 9000ms, bei SP_1 = 0,72 sind das 32 Umdrehungen Spirale öffnend
														// und 32 Umdrehungen Spirale schliessend 
														// 9000ms, bei SP_1 = 0,36 sind das 16 Umdrehungen Spirale öffnend
														// und 16 Umdrehungen Spirale schliessend 
	{
		VZ_2 = -VZ_2;
	}	
