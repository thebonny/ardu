...
//	Die Parameter sollten in einer RATSCHEN_INIT() Init-Routine eingestellt werden, ... nicht hier, alle 1ms!
	R_oben				= -400;													// oberer  maximaler Ratschenpunkt
	R_unten				= +400;												// unterer maximaler Ratschenpunkt
	R_Anzahl			= 3;													// Anzahl von Ratschen-Punkte
...
//	Reglerparameter:
	kp_p_y_r		= 0.001;						// harte Charakteristik
//	ki_p_y_r		= 0.0;
	kd_p_y_r		= 0.0035;
