...
space_vector motor_X_space_vector = { 0.0, 0.0, 0.0 };
space_vector motor_Y_space_vector = { 0.0, 0.0, 0.0 };	
...
//	REGLER POSITION
	...
	compute_space_vector_motor_X(&motor_X_space_vector, pid_compute(&motor_X_position));

	motor_Y_position.input = get_average_adc_input_Y();
	compute_space_vector_motor_Y(&motor_Y_space_vector, pid_compute(&motor_Y_position));
	


//	Gemeinsame Raumvektorausgabe ---------------------------------------------------------------------------------------------	
		SVPWM(motor_X_space_vector.X, motor_X_space_vector.Y, motor_X_space_vector.Z, motor_Y_space_vector.X, motor_Y_space_vector.Y, motor_Y_space_vector.Z);
